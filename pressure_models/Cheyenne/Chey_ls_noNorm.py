...
path = '/home/rui/Documents/Willowglen/data/PresConstr_Data/'

# Arguments
parser.add_argument("--data", help="Data to be loaded into the model", default=path + 'Chey_Pres.csv')
...
parser.add_argument("--epochs", help="Number of times data should be recycled through", default=500)
parser.add_argument("--tensorboard_path", help="Location of saved tensorboard information", default="./tensorboard")
parser.add_argument("--model_path", help="Location of saved tensorflow graph", default='checkpoints/ls_noNorm.ckpt')
...
with tf.Session() as sess:
    ...
    seq_pred(session=sess, model=z, normalizer=None, data=raw_data, time_start=1, time_end=5000, adv_plot=False)
